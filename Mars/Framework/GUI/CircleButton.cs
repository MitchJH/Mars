...
namespace Mars
{
    ...
    public class CircleButton : Button
    {
        ...
        public CircleButton(String name, String text, Vector3 CenterRadius, Texture2D texture, SpriteFont font, Color foreColor, Color? backColor = null, Viewport? viewport = null)
            : base(name, text, new Rectangle((int)(CenterRadius.X - CenterRadius.Z), (int)(CenterRadius.Y - CenterRadius.Z), (int)(2f * CenterRadius.Z), (int)(2f * CenterRadius.Z)), texture, font, foreColor, backColor, viewport)
        {
        }
