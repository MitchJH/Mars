...
namespace Mars
{
    ...
    public class PictureBox : GUIControl
    {
        ...
        public PictureBox(String name, Rectangle PositionWidthHeight, Texture2D image, SizeMode sizeMode = SizeMode.Normal, Color? backColor = null, Viewport? viewport = null)
            : base(name,"",PositionWidthHeight,image,null,Color.Transparent, backColor, viewport)
        {
