...
namespace Mars
{
    ...
    public abstract class GUIControl
    {
        ...
        protected static Color inactiveColor = Color.White;//new Color(240, 240, 240);
        ...
        public GUIControl(String name, String text, Rectangle PositionWidthHeight, Texture2D texture, SpriteFont font, Color foreColor, Color? backColor = null, Viewport? viewport = null)
        {
        ...
        public virtual void Draw(SpriteBatch spriteBatch)
        {
            ...
            Color col = hasFocus ? backColor : inactiveColor;
        ...
        /// <summary>
        /// Gets or sets the origin position of any drawn text.
        /// </summary>
