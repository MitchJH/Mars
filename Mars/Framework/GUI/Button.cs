...
namespace Mars
{
    ...
    public class Button : GUIControl
    {
        ...
        public Button(String name, String text, Rectangle PositionWidthHeight, Texture2D texture, SpriteFont font, Color foreColor, Color? backColor = null, Viewport? viewport = null)
            : base(name, text, PositionWidthHeight, texture, font, foreColor, backColor, viewport)
        {
            base.TextPosition = TextPosition.Center;
