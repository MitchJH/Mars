...
namespace Mars
{
    ...
    public class Label : GUIControl
    {
        ...
        public Label(String name, String text, Vector2 position, SpriteFont font, Color foreColor, int charsPerLine, int distanceBetweenLines, Color? backColor = null, Viewport? viewport = null)
            : base(name, text, new Rectangle((int)position.X, (int)position.Y, 1, 1), null, font, foreColor, backColor, viewport)
        {
