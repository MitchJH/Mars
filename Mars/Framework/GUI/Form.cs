...
namespace Mars
{
    ...
    public class Form : GUIControl
    {
        ...
        public Form(String name, String text, Rectangle PositionWidthHeight, Texture2D texture, SpriteFont font, Color foreColor, Color? backColor = null, Viewport? viewport = null)
