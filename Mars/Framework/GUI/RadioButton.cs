...
namespace Mars
{
    ...
    public class RadioButton : CheckBox
    {
        ...
        public RadioButton(String name, String text, Rectangle PositionWidthHeight, Texture2D texture, SpriteFont font, Color foreColor, Color? backColor = null, Viewport? viewport = null)
